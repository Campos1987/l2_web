    ...
    <div className=' min-h-screen py-12 px-6'>
      <div className='max-w-5xl mx-auto space-y-12'>
        ...
        <p className='mt-3 max-w-2xl'>
          ...
          para oferecer batalhas intensas, jogabilidade dinâmica e uma
          comunidade vibrante de jogadores apaixonados por ação. Aqui, cada dia
          é uma nova oportunidade para provar sua força, estratégia e conquistar
          glória nos campos de batalha.
        </p>
        ...
        <div className='grid gap-6 md:grid-cols-2'>
          <div className='rounded-2xl container'>
            ...
            <ul className='list-disc marker:text-violet-500 marker:text-2xl pl-4'>
              ...
              <li className='py-2'>
                ...
                inovações que simplificam o gameplay, tornando tudo mais
          ...
          <div className='rounded-2xl container'>
            <h2>Nossa missão</h2>
            <span className='pt-2'>
              Nosso objetivo é proporcionar a melhor experiência PvP possível,
              com eventos diários, suporte ativo e constante inovação. Se você
              busca um servidor onde habilidade e tática definem o vencedor, seu
              lugar é aqui.
            </span>
            <div className='mt-6 grid grid-cols-2 gap-4'>
              <div className='rounded-2xl container'>
                <p className='text-sm '>Rates e Ritmo</p>
