...
export namespace Prisma {
  ...
  */
  ...
  export type accountsOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"login" | "password" | "email" | "name" | "created_time" | "lastactive" | "accessLevel" | "lastIP" | "lastServer" | "pcIp" | "hop1" | "hop2" | "hop3" | "hop4", ExtArgs["result"]["accounts"]>
  ...
  export interface accountsDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const accountsWithLoginOnly = await prisma.accounts.findMany({ select: { login: true } })
     * 
     */
  ...
  interface accountsFieldRefs {
    readonly login: FieldRef<"accounts", 'String'>
    readonly password: FieldRef<"accounts", 'String'>
    readonly email: FieldRef<"accounts", 'String'>
    readonly name: FieldRef<"accounts", 'String'>
    readonly created_time: FieldRef<"accounts", 'DateTime'>
    readonly lastactive: FieldRef<"accounts", 'BigInt'>
    readonly accessLevel: FieldRef<"accounts", 'Int'>
    readonly lastIP: FieldRef<"accounts", 'String'>
    readonly lastServer: FieldRef<"accounts", 'Int'>
    readonly pcIp: FieldRef<"accounts", 'String'>
    readonly hop1: FieldRef<"accounts", 'String'>
    readonly hop2: FieldRef<"accounts", 'String'>
    readonly hop3: FieldRef<"accounts", 'String'>
    readonly hop4: FieldRef<"accounts", 'String'>
  }
  ...
  export type accountsWhereInput = {
    ...
    login?: StringFilter<"accounts"> | string
    ...
    created_time?: DateTimeFilter<"accounts"> | Date | string
    lastactive?: BigIntFilter<"accounts"> | bigint | number
    accessLevel?: IntFilter<"accounts"> | number
    lastIP?: StringNullableFilter<"accounts"> | string | null
    lastServer?: IntNullableFilter<"accounts"> | number | null
    pcIp?: StringNullableFilter<"accounts"> | string | null
    hop1?: StringNullableFilter<"accounts"> | string | null
    hop2?: StringNullableFilter<"accounts"> | string | null
    hop3?: StringNullableFilter<"accounts"> | string | null
    hop4?: StringNullableFilter<"accounts"> | string | null
  }
  ...
  export type accountsOrderByWithRelationInput = {
    ...
    lastServer?: SortOrderInput | SortOrder
    pcIp?: SortOrderInput | SortOrder
    hop1?: SortOrderInput | SortOrder
    hop2?: SortOrderInput | SortOrder
    hop3?: SortOrderInput | SortOrder
    hop4?: SortOrderInput | SortOrder
  ...
  export type accountsScalarWhereWithAggregatesInput = {
    ...
    login?: StringWithAggregatesFilter<"accounts"> | string
    ...
    created_time?: DateTimeWithAggregatesFilter<"accounts"> | Date | string
    lastactive?: BigIntWithAggregatesFilter<"accounts"> | bigint | number
    accessLevel?: IntWithAggregatesFilter<"accounts"> | number
    lastIP?: StringNullableWithAggregatesFilter<"accounts"> | string | null
    lastServer?: IntNullableWithAggregatesFilter<"accounts"> | number | null
    pcIp?: StringNullableWithAggregatesFilter<"accounts"> | string | null
    hop1?: StringNullableWithAggregatesFilter<"accounts"> | string | null
    hop2?: StringNullableWithAggregatesFilter<"accounts"> | string | null
    hop3?: StringNullableWithAggregatesFilter<"accounts"> | string | null
    hop4?: StringNullableWithAggregatesFilter<"accounts"> | string | null
  }
  ...
  export type accountsUpdateInput = {
    ...
    lastactive?: BigIntFieldUpdateOperationsInput | bigint | number
    accessLevel?: IntFieldUpdateOperationsInput | number
    lastIP?: NullableStringFieldUpdateOperationsInput | string | null
    lastServer?: NullableIntFieldUpdateOperationsInput | number | null
    pcIp?: NullableStringFieldUpdateOperationsInput | string | null
    hop1?: NullableStringFieldUpdateOperationsInput | string | null
    hop2?: NullableStringFieldUpdateOperationsInput | string | null
    hop3?: NullableStringFieldUpdateOperationsInput | string | null
    hop4?: NullableStringFieldUpdateOperationsInput | string | null
  }
